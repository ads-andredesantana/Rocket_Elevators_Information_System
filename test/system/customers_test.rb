...
class CustomersTest < ApplicationSystemTestCase
  ...
  test "creating a Customer" do
    ...
    fill_in "Headquaters address", with: @customer.headquaters_address
    fill_in "Technical authority phone", with: @customer.technical_authority_phone
    fill_in "Technichal manager email for service", with: @customer.technichal_manager_email_for_service
