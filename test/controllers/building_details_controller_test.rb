...
class BuildingDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building_detail" do
    assert_difference('BuildingDetail.count') do
      post building_details_url, params: { building_detail: { building_id: @building_detail.building_id, key: @building_detail.key, value: @building_detail.value } }
    end
  ...
  test "should update building_detail" do
    patch building_detail_url(@building_detail), params: { building_detail: { building_id: @building_detail.building_id, key: @building_detail.key, value: @building_detail.value } }
