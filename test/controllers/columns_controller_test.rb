...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { Information: @column.Information, Notes: @column.Notes, NumberOfFloor: @column.NumberOfFloor, PropertyType: @column.PropertyType, Status: @column.Status, battery_id: @column.battery_id } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { Information: @column.Information, Notes: @column.Notes, NumberOfFloor: @column.NumberOfFloor, PropertyType: @column.PropertyType, Status: @column.Status, battery_id: @column.battery_id } }
